...
client = MongoClient('mongodb+srv://test:sparta@cluster0.6bd2d.mongodb.net/?retryWrites=true&w=majority', 27017)
db = client.dbsparta
app = Flask(__name__)
...
def get_post():
    ...
    like_count = db.likes.count_documents({"post_id": post_id_receive, "like": 1})
    unlike_count = db.likes.count_documents({"post_id": post_id_receive, "like": -1})
